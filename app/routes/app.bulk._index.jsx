...
export const loader = async ({ request }) => {
  ...
  try {
    ...
    console.warn("[app.bulk] stale recovery failed:", err);
  }
  ...
  // dashboard can show *which* products failed without forcing a click-through.
...
export default function BulkUploadPage() {
  ...
  return (
    ...
    >
      ...
      <BlockStack gap="500">
        <ResourceEditTabs tabs={PRODUCT_EDIT_TABS} activeTab="bulk" />
        {clientError && (
          <Banner
            tone="critical"
            ...
            {selectedJob && (
              <BlockStack gap="300">
                ...
                {selectedJob.failedRows === 0 ? (
                  <Banner tone="success" title="All products updated">
                    <p>
                      No failures in this job. {selectedJob.successRows} of{" "}
                      {selectedJob.totalRows} products were updated successfully.
                    </p>
                  </Banner>
                ) : (
                  <BlockStack gap="200">
                    <Text as="h3" variant="headingSm" tone="critical">
                      Failed products ({selectedJob.failedRows})
                    </Text>
                    <BlockStack gap="200">
